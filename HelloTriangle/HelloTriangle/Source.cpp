...
//#endif
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Ola, Meu Nome eh Jose Malafaia", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// PONTOS - GL_POINTS
		// Removi os pontos comentando eles pra não precisar apagar o código
		// 
